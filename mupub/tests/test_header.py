...
class HeaderTest(unittest.TestCase):
    ...
    def _check_header(self, header):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), TEST_DATA, "basic-hdr.ly")
    ...
    def test_unicode_read(self):
        ...
        path = os.path.join(os.path.dirname(__file__), TEST_DATA, "unicode-hdr.ly")
    ...
    def test_throws_badfile(self):
        ...
        header = mupub.Header(mupub.LYLoader())
        path = os.path.join(os.path.dirname(__file__), TEST_DATA, "foo-bar.ly")
    ...
    def test_raw(self):
        ...
        path = os.path.join(os.path.dirname(__file__), TEST_DATA, "hdr-raw.ly")
        header.load_table(path)
    ...
    def test_bad_header(self):
        ...
        header = mupub.Header(mupub.LYLoader())
        path = os.path.join(os.path.dirname(__file__), TEST_DATA, "bad-header.ly")
        header.load_table(path)
